...
wget https://www.libsdl.org/release/SDL2-devel-2.0.16-VC.zip && 7z x SDL2-devel-2.0.16-VC.zip || exit 1
export SDL_ROOT="$APPVEYOR_BUILD_FOLDER/SDL2-2.0.16" || exit 1
